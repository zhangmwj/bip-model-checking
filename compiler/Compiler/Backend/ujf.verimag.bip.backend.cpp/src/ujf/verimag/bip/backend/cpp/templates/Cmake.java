...
/**
 * Entry point of the 'Cmake' generation module.
 *
 * @generated
 */
public class Cmake extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/ujf/verimag/bip/backend/cpp/templates/cmake";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "generateMasterCMakeLists" };
     ...
     * @generated
     */
    public Cmake(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public Cmake(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Cmake generator = new Cmake(modelURI, folder, arguments);
