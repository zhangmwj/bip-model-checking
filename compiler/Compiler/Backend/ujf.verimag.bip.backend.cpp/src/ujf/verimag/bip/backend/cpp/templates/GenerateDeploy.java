 ...
 *******************************************************************************/
package ujf.verimag.bip.backend.cpp.templates;
...
/**
 * Entry point of the 'GenerateDeploy' generation module.
 *
 * @generated
 */
public class GenerateDeploy extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/ujf/verimag/bip/backend/cpp/templates/generateDeploy";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "generateDeploy" };
     ...
     * @generated
     */
    public GenerateDeploy(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public GenerateDeploy(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateDeploy generator = new GenerateDeploy(modelURI, folder, arguments);
