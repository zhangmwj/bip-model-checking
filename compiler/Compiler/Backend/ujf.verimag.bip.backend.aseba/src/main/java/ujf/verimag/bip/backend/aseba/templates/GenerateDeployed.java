 ...
 *******************************************************************************/
package ujf.verimag.bip.backend.aseba.templates;
 ...
 * @generated
 */
public class GenerateDeployed extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/ujf/verimag/bip/backend/aseba/templates/generateDeployed";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "generateDeployed" };
     ...
     * @generated
     */
    public GenerateDeployed(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public GenerateDeployed(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateDeployed generator = new GenerateDeployed(modelURI, folder, arguments);
