/**
 */
package bip2.ujf.verimag.bip.property.util;
...
public class PropertyAdapterFactory extends AdapterFactoryImpl {
    ...
    protected PropertySwitch<Adapter> modelSwitch = new PropertySwitch<Adapter>() {
        ...
        @Override
        public Adapter caseStringToPropertyMapEntry(
                Map.Entry<String, Property> object) {
            return createStringToPropertyMapEntryAdapter();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link bip2.ujf.verimag.bip.property.Property <em>Property</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link bip2.ujf.verimag.bip.property.Properties <em>Properties</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link java.util.Map.Entry <em>String To Property Map Entry</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
